...
var main = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var client, id, query, rowCount, body, message, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                body = { data: {} };
                if (rowCount === 0) {
                    message = "Error: Medication record does not exist for id " + id;
                    body.error = {
                        code: 600,
                        message: message,
                    };
                }
                response = __assign({}, response_1.responseBase);
...
exports.main = main;
//# sourceMappingURL=delete-medication.js.map