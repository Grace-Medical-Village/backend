...
var main = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var client, name, birthdate, text, patientSearchStatementBase, fullName, query, rows, body, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                name = request_1.getParameter(event, 'name', false);
                birthdate = request_1.getParameter(event, 'birthdate', false);
                text = 'select * from patient;';
                patientSearchStatementBase = 'select id, first_name, last_name, birthdate, gender, mobile from patient';
                if (name && typeof name === 'string') {
                    ...
                    request_1.checkIso8601Format(birthdate)) {
...
exports.main = main;
//# sourceMappingURL=get-patients.js.map